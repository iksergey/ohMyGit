...
* ui_components
* feedback
Предлагаю сделать чат- сборник частых ошибок при работе с git на начальных этапах. Это поможет новичкам быстрее с ними справляться и не задавать одни и те же вопросы
не запускается git - надо представиться. Инструкция. 
что делать, если "не распознано имя командлета"
