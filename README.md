...
> Любопытно что Fork в переводе с гретбритишного - вилка. Складывается устойчивое впечатление что Линус Торвальдс поторопился с названием ветки веткой (branch). А как интересно называлась бы сущность, представляющая ветвление между предельноразными workflow? Грабли? Rake?

## Чуть позже здесь появятся и другие команды по ветвлению и слиянию...
### ***Coming soon...***
